...
def auto_backup():
    ...
    # DESABILITADO TEMPORARIAMENTE - Google Drive sem espaço
    # Usando apenas backup local que funciona perfeitamente
    print("ℹ️ [BACKUP] Usando backup local JSON (Google Sheets desabilitado)")
    return backup_to_local_json()
